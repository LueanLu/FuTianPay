export default {
  ...
  CatalogueData: [
    ...
    { Title: '夜晚還年輕', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/lXLQaLuAdVg', Img: 'assets/img/portfolio/41.jpg', ImgAlt: '夜晚還年輕' },
    // 40　Absolutely Anything　超能玩很大　超能玩很大　發行
    { Title: '超能玩很大', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/79gNsBZGW6E', Img: 'assets/img/portfolio/40.jpg', ImgAlt: '超能玩很大' },
    ...
    { Title: '共犯', Business: '製作 發行 銷售', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/EC8jMlUvw9A', Img: 'assets/img/portfolio/37.jpg', ImgAlt: '共犯' },
    ...
    // 35　MIDA　夢見　梦见　銷售
    { Title: '夢見', Business: '銷售', BusinessType: 'sales', Youtube: 'https://youtu.be/c4781YV6k08', Img: 'assets/img/portfolio/35.jpg', ImgAlt: '夢見' },
    ...
    { Title: '白天的星星', Business: '銷售', BusinessType: 'sales', Youtube: 'https://youtu.be/h4QLpn9pIdI', Img: 'assets/img/portfolio/32.jpg', ImgAlt: '白天的星星' },
    ...
    { Title: '愛的麵包魂', Business: '製作 發行 銷售', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/iVLd1-2KyzU', Img: 'assets/img/portfolio/30.jpg', ImgAlt: '愛的麵包魂' },
    ...
    { Title: '破曉開戰', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/7wy82McLxkw', Img: 'assets/img/portfolio/28.jpg', ImgAlt: '破曉開戰' },
    // 27　Killer Elite　特種菁英　特种菁英　發行
    { Title: '特種菁英', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/qAHqv4qXpmo', Img: 'assets/img/portfolio/27.jpg', ImgAlt: '特種菁英' },
    // 26 The Kids Are All Right　性福拉警報　性福拉警报　發行
    { Title: '性福拉警報', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/PLzixJjuOJ4', Img: 'assets/img/portfolio/26.jpg', ImgAlt: '性福拉警報' },
    ...
    { Title: '陌路姐妹淘', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/-dsmW7zXxpQ', Img: 'assets/img/portfolio/24.jpg', ImgAlt: '陌路姐妹淘' },
    // 23　The Experiment　叛獄風雲　叛狱风云　發行
    { Title: '叛獄風雲', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/G3lwyfjNKqg', Img: 'assets/img/portfolio/23.jpg', ImgAlt: '叛獄風雲' },
    // 22　Hachiko　忠犬小八　忠犬小八　發行
    { Title: '忠犬小八', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/STo6qN4_Eq0', Img: 'assets/img/portfolio/22.jpg', ImgAlt: '忠犬小八' },
    // 21　The King of Fighters　格鬥天王　格斗天王　製作　發行　銷售
    { Title: '格鬥天王', Business: '製作 發行 銷售', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/SAv1yXIVm_k', Img: 'assets/img/portfolio/21.jpg', ImgAlt: '格鬥天王' },
    ...
    { Title: '交錯效應', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/qTLCiNwNIb8', Img: 'assets/img/portfolio/14.jpg', ImgAlt: '交錯效應' },
    // 13　10 Questions for the Dalai Lama　達賴喇嘛十問　达赖喇嘛十问　發行
    { Title: '達賴喇嘛十問', Business: '發行', BusinessType: 'publication', Youtube: 'https://youtu.be/YjAA_ItX8jc', Img: 'assets/img/portfolio/13.jpg', ImgAlt: '達賴喇嘛十問' },
    // 12　The Eye　變眼　变眼　發行
    ...
    { Title: '伊媚兒新娘', Business: '製作 發行', BusinessType: 'make publication', Youtube: 'https://youtu.be/72geD_LHEU0', Img: 'assets/img/portfolio/01.jpg', ImgAlt: '伊媚兒新娘' },
  ],
  // IndexAbout
  IndexAbout: {
    Title: 'ABOUT',
    ...
    Content: [
      ...
      { info: '2021年起開始參與投資製作劇集《What The Hell Is Love愛的混混》、《中元大餐》、《妮波自由式》…等等，將帶給觀眾全方位影視作品。' },

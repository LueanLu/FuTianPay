export default {
  ...
  CatalogueData: [
    ...
    { Title: 'Tangerine', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/lXLQaLuAdVg', Img: 'assets/img/portfolio/41.jpg', ImgAlt: 'Tangerine' },
    // 40　Absolutely Anything　超能玩很大　超能玩很大　發行
    { Title: 'Absolutely Anything', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/79gNsBZGW6E', Img: 'assets/img/portfolio/40.jpg', ImgAlt: 'Absolutely Anything' },
    ...
    { Title: 'Partner In Crime', Business: 'Production Distribution Sales', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/EC8jMlUvw9A', Img: 'assets/img/portfolio/37.jpg', ImgAlt: 'Partner In Crime' },
    ...
    // 35　MIDA　夢見　梦见　銷售
    { Title: 'MIDA', Business: 'Sales', BusinessType: 'sales', Youtube: 'https://youtu.be/c4781YV6k08', Img: 'assets/img/portfolio/35.jpg', ImgAlt: 'MIDA' },
    ...
    { Title: 'Love Is Sin', Business: 'Sales', BusinessType: 'sales', Youtube: 'https://youtu.be/h4QLpn9pIdI', Img: 'assets/img/portfolio/32.jpg', ImgAlt: 'Love Is Sin' },
    ...
    { Title: 'The Soul of Bread', Business: 'Production Distribution Sales', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/iVLd1-2KyzU', Img: 'assets/img/portfolio/30.jpg', ImgAlt: 'The Soul of Bread' },
    ...
    { Title: 'Tomorrow, When the War Began', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/7wy82McLxkw', Img: 'assets/img/portfolio/28.jpg', ImgAlt: 'Tomorrow, When the War Began' },
    // 27　Killer Elite　特種菁英　特种菁英　發行
    { Title: 'Killer Elite', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/qAHqv4qXpmo', Img: 'assets/img/portfolio/27.jpg', ImgAlt: 'Killer Elite' },
    // 26 The Kids Are All Right　性福拉警報　性福拉警报　發行
    { Title: 'The Kids Are All Right', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/PLzixJjuOJ4', Img: 'assets/img/portfolio/26.jpg', ImgAlt: 'The Kids Are All Right' },
    ...
    { Title: 'Happy Tears', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/-dsmW7zXxpQ', Img: 'assets/img/portfolio/24.jpg', ImgAlt: 'Happy Tears' },
    // 23　The Experiment　叛獄風雲　叛狱风云　發行
    { Title: 'The Experiment', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/G3lwyfjNKqg', Img: 'assets/img/portfolio/23.jpg', ImgAlt: 'The Experiment' },
    // 22　Hachiko　忠犬小八　忠犬小八　發行
    { Title: 'Hachiko', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/STo6qN4_Eq0', Img: 'assets/img/portfolio/22.jpg', ImgAlt: 'Hachiko' },
    // 21　The King of Fighters　格鬥天王　格斗天王　製作　發行　銷售
    { Title: 'The King of Fighters', Business: 'Production Distribution Sales', BusinessType: 'make publication sales', Youtube: 'https://youtu.be/SAv1yXIVm_k', Img: 'assets/img/portfolio/21.jpg', ImgAlt: 'The King of Fighters' },
    ...
    { Title: 'The Air I Breathe', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/qTLCiNwNIb8', Img: 'assets/img/portfolio/14.jpg', ImgAlt: 'The Air I Breathe' },
    // 13　10 Questions for the Dalai Lama　達賴喇嘛十問　达赖喇嘛十问　發行
    { Title: '10 Questions for the Dalai Lama', Business: 'Distribution', BusinessType: 'publication', Youtube: 'https://youtu.be/YjAA_ItX8jc', Img: 'assets/img/portfolio/13.jpg', ImgAlt: '10 Questions for the Dalai Lama' },
    // 12　The Eye　變眼　变眼　發行
    ...
    { Title: 'Mail Order Wife', Business: 'Production Distribution', BusinessType: 'make publication', Youtube: 'https://youtu.be/72geD_LHEU0', Img: 'assets/img/portfolio/01.jpg', ImgAlt: 'Mail Order Wife' },
  ],
  // IndexAbout
  IndexAbout: {
    Title: 'ABOUT',
